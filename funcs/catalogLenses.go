...
// FocusReleaseByName traverses a module catalog and returns a release by name.
...
func PluckReleaseByName(cat api.ModuleCatalog, releaseName api.ReleaseName) (*api.Release, error) {
...
// PluckReleaseItem traverses a module catalog and returns a wareID looked up
// by release and item label.
//
// Any error will be of category LookupError.
func PluckReleaseItem(cat api.ModuleCatalog, releaseName api.ReleaseName, itemName api.ItemName) (*api.WareID, error) {
